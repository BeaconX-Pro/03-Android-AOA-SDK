package com.moko.support.ac.entity;
...
public enum ParamsKeyEnum implements Serializable {
    ...
    KEY_RESET_BY_BTN_ENABLE(0x38),
    KEY_POWER_SAVING_ADV_PARAMS(0x3C),
    KEY_SENSOR_TYPE(0x39),
    KEY_BTN_ADV_ENABLE(0x3F),
    KEY_NORMAL_ADV_PARAMS_QH(0x41),
    KEY_PASSWORD(0x51),
